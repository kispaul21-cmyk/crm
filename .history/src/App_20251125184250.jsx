...
import { 
  LayoutDashboard, CheckSquare, Building2, Search, Paperclip, Send, MoreVertical, ChevronLeft, ChevronRight 
} from 'lucide-react';
...
const App = () => {
  ...
  async function updateStage(newStageId) {
    ...
    if (!error) {
      ...
      setSelectedDeal(null); // Закрываем чат
      setActiveStageId(Number(newStageId)); // Переходим в новую папку
    }
  }
      ...
      {selectedDeal && (
        <div className="w-72 bg-white border-l border-gray-200 flex flex-col flex-shrink-0">
          ...
          <div className="p-5 border-b border-gray-100 bg-gray-50">
            <h3 className="text-xs font-bold text-gray-400 uppercase mb-2">Этап сделки</h3>
            <select 
          ...
          <div className="p-5 border-b border-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-blue-600 cursor-pointer">Профиль</div>
              </div>
            </div>
          </div>
        </div>
