            ...
            <div className="flex gap-3 items-center">
              <div className="flex-1 relative">
                <input
                  ...
                  disabled={noInn}
                  className={`w-full pl-3 pr-10 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition font-mono text-slate-700 ${noInn ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white'
                    }`}
                />
                {isFetchingInn && (
                  <div className="absolute right-3 top-3.5">
