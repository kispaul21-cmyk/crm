            ...
            <div className="bg-white/90 border-b border-gray-200 px-6 py-4 backdrop-blur-sm max-h-64 overflow-y-auto custom-scrollbar shadow-sm">
                ...
                <div className="flex flex-col">
                    ...
                    <form
                        ...
                        className="flex items-center gap-3 py-2 px-2 mt-1 hover:bg-gray-50 rounded-lg transition group"
                    >
                        <button
                            type="submit"
                        ...
                        >
                            <Plus size={16} className={`transition ${dealTasks.filter(t => !t.is_done).length >= 5 ? 'text-gray-300' : 'text-blue-400 group-hover:text-blue-600'}`} />
                        </button>
