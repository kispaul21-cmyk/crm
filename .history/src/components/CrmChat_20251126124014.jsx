...
const CrmChat = ({
    ...
    useEffect(() => {
        ...
        return () => window.removeEventListener('messageColorsChanged', handleColorChange);
    }, []);
    ...
    return (
        <div className="flex-1 flex flex-col bg-[#eef1f5] min-w-[500px]">
            ...
            {/* Quick Tasks Panel */}
            {/* Removed overflow-y-auto to allow floating subtasks to overflow */}
                        ...
                        <div key={item.id} className={`flex gap-3 group mb-2 ${item.is_me ? 'flex-row-reverse' : ''}`}>
                            ...
                            <div className="max-w-[80%]">
                                ...
                                {item.text.startsWith('⚡') ? (
                                    ...
                                    <div className={`p-3 rounded-2xl text-sm shadow-sm ${colors.bg} ${colors.text} ${item.is_me ? 'rounded-tr-none' : 'rounded-tl-none'}`}>
            ...
            <div className="p-4 bg-white border-t border-gray-200">
                ...
                <div className="flex items-center gap-2 bg-white p-2 rounded-xl border border-gray-200 focus-within:border-blue-500 transition-all relative shadow-sm">
                    {/* Emoji picker toggle */}
                    <button
                        type="button"
