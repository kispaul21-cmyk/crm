...
const TaskBubble = ({ task, toggleTask, toggleSubtask, deleteTask, taskFontClass, emojiMultiplier }) => {
    ...
    return (
        <div className="flex gap-3 mb-4 group">
            <div 
                className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 flex-shrink-0 shadow-sm border border-emerald-200"
                style={{ fontSize: `${16 * emojiMultiplier}px` }}
            >
                <ListChecks size={16} />
            </div>
