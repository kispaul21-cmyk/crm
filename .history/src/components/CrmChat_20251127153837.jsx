                        ...
                        <div key={item.id} className={`flex gap-3 group mb-2 ${item.is_me ? 'flex-row-reverse' : ''}`}>
                            ...
                            <div className="max-w-[80%]">
                                ...
                                {item.text.startsWith('⚡') ? (
                                    <div className="bg-gray-100 border border-gray-200 text-slate-500 px-3 py-1.5 rounded-lg inline-flex items-center gap-2">
                                        <span style={{ fontSize: `${20 * emojiMultiplier}px` }}>⚡</span>
                                        <span className="text-xs">{item.text.slice(1).trim()}</span>
                                    </div>
                                ) : (
