...
const CrmChat = ({
    ...
    return (
        <div className="flex-1 flex flex-col bg-[#eef1f5] overflow-hidden relative">
            ...
            <div
                className="bg-white border-b border-gray-100 flex-shrink-0 relative"
            >
                <div
                    className="h-16 flex items-center justify-between px-6 cursor-pointer hover:bg-gray-50 transition-colors"
