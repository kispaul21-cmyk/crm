...
import { FileText, Download, Phone, Mail, X, History } from 'lucide-react';
    ...
    <div className="w-full h-full bg-white border-l border-gray-200 flex flex-col">
      ...
      <div className="flex px-1 border-b border-gray-200">
        ...
        <button
          ...
          className={`tab-btn flex-1 py-2 text-xs font-bold transition text-center border-b-2 ${activeTab === 'files'
              ? 'border-blue-500 text-blue-600'
              : 'border-transparent text-slate-400 hover:bg-slate-50 hover:text-slate-600'
            }`}
        >
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {activeTab === 'info' && (
          <div className="p-4 space-y-4 animate-fadeIn">
            ...
            {/* Редактирование сделки отключено — удалён триггер открытия панели редактирования */}
          </div>
        )}
