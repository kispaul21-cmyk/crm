...
const CrmStages = ({ stages, deals, activeStageId, setActiveStageId, isCollapsed, setIsCollapsed, setSelectedDeal }) => {
  return (
      ...
      <div className="border-b border-gray-100">
        <div className="h-10 flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-1">
            {!isCollapsed && (
              <button className="p-1 hover:bg-gray-100 rounded text-slate-400" title="Фильтры">
                <Filter size={16} />
              </button>
            )}
