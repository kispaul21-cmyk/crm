        ...
        {filteredStages.map(stage => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center justify-between p-3 transition-all rounded-l-lg ${isActive ? 'bg-slate-100 text-slate-900' : 'text-slate-500 hover:bg-slate-50'} border-r-4 border-r-transparent`}
