...
const buttonClasses = `h-[98px] relative flex items-center justify-between w-full px-3 transition-all border-b border-gray-100 text-left ${isActive    ? 'bg-slate-100 text-slate-900'
