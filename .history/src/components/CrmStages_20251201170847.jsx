...
const StageButton = ({ stage, dealCount, isActive, onClick, fontClass }) => {
  const buttonClasses = `h-10 relative flex items-center justify-between w-full px-3 transition-all rounded-lg text-left ${isActive
...
const CrmStages = ({
  ...
  return (
    <div className="w-full h-full bg-white border-r border-gray-200 flex flex-col relative z-20">
      ...
      {/* Список этапов */}
      <div className="flex-1 overflow-y-auto p-2 space-y-1">{filteredStages.map(stage => {
