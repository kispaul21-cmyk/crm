            ...
            <div className="flex-shrink-0 bg-white border-b border-gray-200">
                <div className="p-6 pb-4">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-2xl font-bold mb-3">
                        ...
                        {deal.inn && <p className="text-sm text-gray-500 mb-2">ИНН: {deal.inn}</p>}
                ...
                <div className="grid grid-cols-4 gap-2 px-6 pb-4">
                    <button
                        ...
                        className={`flex flex-col items-center gap-2 p-3 rounded-xl transition ${activeTab === 'contacts'
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-2 p-3 rounded-xl transition ${activeTab === 'tasks'
                            ? 'bg-blue-50 text-blue-600'
                            : 'text-gray-500 hover:bg-gray-50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-2 p-3 rounded-xl transition ${activeTab === 'history'
                            ? 'bg-blue-50 text-blue-600'
                            : 'text-gray-500 hover:bg-gray-50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center gap-2 p-3 rounded-xl transition ${activeTab === 'files'
                            ? 'bg-blue-50 text-blue-600'
                            : 'text-gray-500 hover:bg-gray-50'
                            }`}
                    >
