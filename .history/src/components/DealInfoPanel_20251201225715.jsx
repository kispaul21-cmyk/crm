...
const DealInfoPanel = ({
    ...
    const handleSave = async () => {
        ...
        const dealData = {
            ...
            // В реальном приложении здесь нужно создавать/искать компанию по ИНН
            // Пока сохраняем как есть, предполагая что бэкенд или триггеры разберутся,
            // или просто сохраняем денормализованные данные если так устроена база
        ...
        // Если это создание новой сделки, и у нас есть название компании,
        // то по-хорошему надо создать запись в таблице companies.
        // Но для MVP/текущей задачи просто сохраняем сделку.
        // (В App.jsx была логика создания компании, здесь мы её упростили)
        ...
        if (deal?.id) {
            ...
            // === CREATE ===
            // Сначала пробуем найти или создать компанию (упрощенно пока просто сохраняем сделку, 
            // но в идеале нужно создавать компанию отдельно)

            // Для простоты пока сохраняем сделку. 
            // Примечание: В реальном приложении нужно сначала создать/найти company_id
            ...
            >
                ...
                >
                    ...
                    <div className="p-8 grid grid-cols-[1fr_1px_1fr] gap-8 overflow-y-auto bg-white">
                        ...
                        {/* Divider */}
                        <div className="w-px bg-[#E5DCD5] h-full"></div>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex-grow flex flex-col">
                                ...
                                <textarea
                                    ...
                                    className="w-full flex-grow min-h-[100px] p-4 bg-[#F3EBE6] border border-[#E5DCD5] rounded-[10px] text-sm font-medium text-[#333] outline-none focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all resize-none"
                                ></textarea>
                            </div>
                        </div>
                    </div>
