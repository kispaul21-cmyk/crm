...
const DealInfoPanel = ({
    ...
    const fetchStages = async () => {
        ...
        if (data && data.length > 0) {
            setStages(data);
            // Если создаем новую сделку, автоматически выбираем первый этап
            if (!deal) {
    ...
    const handleSave = async () => {
        ...
        if (!formData.stage) {
            alert('Пожалуйста, выберите этап сделки');
            return;
        }
        ...
        if (formData.company) {
            ...
            if (existing) {
                ...
                if (createError) {
                    console.error('Error creating company from DaData:', createError);
                    alert('Ошибка создания компании: ' + createError.message);
                    return;
                }
                ...
                >
                    ...
                    <div className="p-8 grid grid-cols-[1fr_1px_1fr] gap-8 overflow-y-auto bg-white">
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="text-[11px] font-extrabold text-[#9CA3AF] uppercase tracking-widest -mb-2">
                                Данные сделки
                            </div>
