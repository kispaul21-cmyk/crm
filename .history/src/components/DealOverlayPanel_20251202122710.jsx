...
const DealOverlayPanel = ({ isOpen, onClose, deal, tasks = [], messages = [] }) => {
    ...
    const [panelHeight, setPanelHeight] = useState(400); // Начальная высота
                ...
                >
                    <div className="flex flex-col h-full">
                        ...
                        <div
                            ...
                            className="h-2 bg-gray-100 hover:bg-blue-100 cursor-ns-resize flex items-center justify-center border-t border-gray-200 transition-colors group"
                        >
...
const ProductsTab = ({ deal }) => {
    // Пример данных товаров (в будущем будет из базы данных)
    const products = [
