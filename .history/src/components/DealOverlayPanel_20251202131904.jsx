...
import { X, User, CheckSquare, Phone, History, ShoppingCart, GripHorizontal } from 'lucide-react';
...
const DealOverlayPanel = ({ isOpen, onClose, deal, tasks = [], messages = [] }) => {
    ...
    const tabs = [
        ...
        { id: 'contacts', label: 'Инфо', icon: User },
...
const TasksTab = ({ tasks, dealId }) => {
    ...
    task.is_done ? 'bg-green-500 border-green-500' : 'border-gray-300'
} `}>
