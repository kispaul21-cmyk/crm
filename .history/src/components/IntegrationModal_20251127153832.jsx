            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl my-8 overflow-hidden transform transition-all">
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-12 py-3 bg-gray-50 border rounded-xl outline-none transition font-mono text-sm ${isValid === true ? 'border-green-500 bg-green-50 focus:ring-4 focus:ring-green-500/10' :
                    ...
                    <button
                        ...
                        className={`w-full py-3 rounded-xl font-bold text-sm transition-all duration-200 flex items-center justify-center gap-2 ${isValidating
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className={`px-8 py-3 font-bold rounded-xl transition-all duration-200 flex items-center gap-2 ${!isValid || isSaving
