...
import { X, Phone, Mail, Globe, User, Building2, Briefcase, Sparkles, Loader } from 'lucide-react';
    ...
    const handleFetchByINN = async () => {
        ...
        try {
            ...
            onChange({
                ...
                description: company.description, // Оставляем как есть
                // Дополнительные поля, если они есть в вашей структуре
                full_name: companyData.full_name,
                kpp: companyData.kpp,
                ogrn: companyData.ogrn,
                legal_address: companyData.legal_address,
                director_post: companyData.director_post,
