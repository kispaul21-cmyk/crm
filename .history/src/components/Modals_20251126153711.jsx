                        ...
                        <div className="flex gap-3 items-center">
                            <div className="flex-1 relative">
                                <input
                                    ...
                                    disabled={noInn}
                                    className={`w-full pl-3 pr-10 py-3 border border-gray-200 rounded-xl outline-none focus:border-blue-500 transition font-mono text-slate-700 ${
                            ...
                            <label className="flex items-center gap-2 cursor-pointer select-none whitespace-nowrap">
                                ...
                                />
                                <span className="text-sm text-gray-600 font-medium">Нет ИНН</span>
                            </label>
                        </div>
                                                ...
                                                {deal.stages && (
                                                    <div className="flex items-center gap-2">
                                                        <div 
                                                            ...
                                                            style={{ backgroundColor: deal.stages.color }}
                                                        />
                                                        <span className="text-sm text-gray-600">{deal.stages.name}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
