...
const ResizablePanel = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-0 ${side === 'right' ? 'left-0' : 'right-0'} bottom-0 w-1 cursor-col-resize hover:bg-blue-500 active:bg-blue-600 transition-colors group`}
        style={{ zIndex: 9999 }}
        onMouseDown={handleMouseDown}
      >
        {/* Расширенная невидимая область для клика */}
        <div className="absolute inset-y-0 -left-2 -right-2" style={{ zIndex: 9999 }} />

        {/* Видимая область при hover */}
        <div className="absolute inset-y-0 -left-1 -right-1 group-hover:bg-blue-100 transition-colors pointer-events-none" />
