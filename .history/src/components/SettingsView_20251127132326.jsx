                                ...
                                <div className="flex gap-2 mb-4 flex-wrap">
                                    {MESSAGE_COLORS.map(color => (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-full ${color.bg} transition-all hover:scale-110 ${
                                                myMessageColor === color.id ? 'ring-4 ring-offset-2 ring-blue-400 scale-110' : ''
                                            }`}
                                            title={color.name}
                                        />
                                    ))}
                                ...
                                <div className="flex gap-2 mb-4 flex-wrap">
                                    {MESSAGE_COLORS.map(color => (
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-full ${color.bg} transition-all hover:scale-110 ${
                                                incomingMessageColor === color.id ? 'ring-4 ring-offset-2 ring-purple-400 scale-110' : ''
                                            }`}
                                            title={color.name}
                                        />
                                    ))}
