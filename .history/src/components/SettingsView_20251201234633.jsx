                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <Reorder.Group axis="y" values={localStages} onReorder={reorderStages} className="space-y-2">
                                {localStages.map(stage => (
                                    <Reorder.Item key={stage.id} value={stage} dragListener={false}>
                                        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-200 hover:bg-gray-100 transition">
                                            <div
                                                className="cursor-move"
                                                onPointerDown={(e) => {
                                                    // Manually trigger drag from this handle
                                                    const item = e.currentTarget.closest('[data-framer-component-type="Reorder.Item"]');
                                                    if (item) {
