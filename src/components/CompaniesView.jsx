...
import { Plus, Building2, Trash } from 'lucide-react';

const CompaniesView = ({ companies, onOpenCard, onDeleteCompany }) => {
    return (
                        ...
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        if (typeof onDeleteCompany === 'function') {
                                            if (window.confirm('Удалить компанию? Это действие нельзя отменить.')) {
